...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minimumTokenBalanceForDividends = 103100 * (10**9); // user must hold 103,100 token
...
contract PPUNKS is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "Pumpkin Punks";
    string constant _symbol = "PPUNKS";
    uint8 constant _decimals = 9;
    uint256 _totalSupply = 10310000000 * (10 ** _decimals);
